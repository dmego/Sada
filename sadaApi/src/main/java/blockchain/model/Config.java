...
public class Config {
	...
	private Config() {
		...
		try {
			 ...
			 * 读取配置文件
			 */
			sdkProperties.load(new FileInputStream("C://itstudy/SadaPlace/sadaApi/src/main/resources/config.properties"));
		} catch (IOException e) {
	...
	public String getChannelPath() {
		...
		try {
			hyperproperties.load(new FileInputStream("C://itstudy/SadaPlace/sadaApi/src/main/resources/hyperledger.properties"));
