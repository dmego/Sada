...
import cn.dmego.utils.ConfigurationUtil;
...
public class QueryDefinition {
	 public static final String DEFAULT_CONFIG_LOCATION = "classpath*:query-res.xml";
	            ...
	            for (int i = 0; i < resources.length; i++) {
	                ...
	                try {
	                    QueryContext queryContext = (QueryContext) ConfigurationUtil.parseXMLObject(
	                    		cn.dmego.pojo.QueryContext.class, resource);
